...
$(& antlr4 -v $version X.g4 -encoding utf-8 -Dlanguage=Java   ; $compile_exit_code = $LASTEXITCODE) | Write-Host
...
$(& javac -cp "${JAR};." XLexer.java XParser.java  Test.java ErrorListener.java ; $compile_exit_code = $LASTEXITCODE) | Write-Host
exit $compile_exit_code
