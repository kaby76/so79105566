...
export class XLexer extends antlr.Lexer {
    ...
    public get literalNames(): (string | null)[] { return XLexer.literalNames; }
    public get symbolicNames(): (string | null)[] { return XLexer.symbolicNames; }
    public get ruleNames(): string[] { return XLexer.ruleNames; }

    public get serializedATN(): number[] { return XLexer._serializedATN; }

    public get channelNames(): string[] { return XLexer.channelNames; }

    public get modeNames(): string[] { return XLexer.modeNames; }
    ...
    private QUALIFIED_ATTR_sempred(localContext: antlr.ParserRuleContext | null, predIndex: number): boolean {
        switch (predIndex) {
        case 0:
    ...
    private static readonly vocabulary = new antlr.Vocabulary(XLexer.literalNames, XLexer.symbolicNames, []);

    public override get vocabulary(): antlr.Vocabulary {
        return XLexer.vocabulary;
    }

    private static readonly decisionsToDFA = XLexer._ATN.decisionToState.map( (ds: antlr.DecisionState, index: number) => new antlr.DFA(ds, index) );
}